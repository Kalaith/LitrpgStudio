...
# Configuration
$SOURCE_DIR = "H:\WebHatchery\apps\litrpg_studio"
...
$DEST_DIR = Join-Path $DEST_ROOT "litrpg_studio"
...
function Build-Frontend {
    ...
    # Set base path for preview environment (litrpg_studio subdirectory)
    if ($Environment -eq 'preview') {
        Write-Info "Setting base path for preview environment..."
        $env:VITE_BASE_PATH = "/litrpg_studio/"
